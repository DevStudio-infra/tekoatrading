        ...
        for i, indicator in enumerate(overlay_indicators):
            ...
            try:
                if ind_type in ['sma', 'ma']:
                    ...
                    print(f"Looking for BB columns: {mid_col}, {upper_col}, {lower_col}", file=sys.stderr)
                    print(f"Available columns: {list(df.columns)}", file=sys.stderr)
                    ...
                    if mid_col in df.columns and upper_col in df.columns and lower_col in df.columns:
                        ...
                        print(f"✅ Successfully plotted Bollinger Bands({period})", file=sys.stderr)
                    else:
                        ...
                        print(f"All available columns: {list(df.columns)}", file=sys.stderr)
